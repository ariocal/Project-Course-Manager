...
import com.gestioncursos.gestioncursos.reports.CursoExporterPDF;
...
public class CursoController {
    ...
    public String guardarCurso(Curso curso, RedirectAttributes redirectAttributes){
        try{
            ...
            redirectAttributes.addFlashAttribute("message","El curso se guardo con exito");
        }catch(Exception e){
    ...
    public String eliminarCurso(@PathVariable Integer id, Model model, RedirectAttributes redirectAttributes){
        try {
                ...
                redirectAttributes.addFlashAttribute("message","El curso se elimino con exito");
            }catch (Exception e){
            redirectAttributes.addFlashAttribute("message",e.getMessage());
        }
        return "redirect:/cursos";
